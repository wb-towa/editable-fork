(function($){
    /*
     * ORIGINAL COPYRIGHT AND AUTHOR INFORMATION:
     *==============================================================*
     * Editable 1.3.3
     *
     ...
     *=============================================================* 
     *
     * EDITABLE FORK INFOMATION
     *
     * Version 1.0 (02.03.2012)
     *
     * Based off of Editable 1.3.3 - http://www.arashkarimzadeh.com/jquery/7-editable-jquery-plugin.html
     *
     * Author: William Baer
     * Email: wb@towa.co
     * Website: http://www.toadwarrior.com
     *
     */
    $.fn.editable = function(options){
        ...
        options.toEditable = function(){
            ...
            if(opts.cancel) {
                 ...
                 * This will allow you to have just a cancel button that works
                 * and submit by clicking anywhere outside of the input (other than
                 * the cancel button obviously) to submit. Seems bug-free. If not
                 * modify as your wish or use the author's original.
                 */
                $('<button/>').appendTo($this)
                    .html(opts.cancel)
